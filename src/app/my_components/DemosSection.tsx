...
const demos = [
  ...
  {
    index: "02",
    title: "Shangarf Kashmir Resort",
    category: "Homestays & Retreats",
    description: "Serene mountain escape featuring seamless day-and-night mode lighting, immersive interior tours, and luxury amenity showcases.",
    href: "/homestays/demo1",
    status: "live",
  },
  {
    index: "03",
    title: "BrewCup Artisan Cafe & Roastery",
    category: "Cafes & Dining",
    description: "Sensory-driven coffeehouse experience with ambient 4K video hero, interactive Rive micro-animations, and dynamic digital menu.",
    href: "/cafe/demo1",
    status: "live",
  },
  {
  ...
  {
    index: "05",
    title: "Villa Serenity & Admin CRM",
    category: "Real Estate & Hospitality",
    description: "Complete villa rental storefront with real-time availability calendar, booking flows, and full administrator management dashboard.",
    href: "/real-estate/demo5",
    status: "live",
  },
];

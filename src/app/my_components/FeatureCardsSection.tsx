...
export default function FeatureCardsSection() {
  ...
  // Listen for tab selection from navbar via custom event
  useEffect(() => {
    ...
    window.addEventListener("services-tab", handleTabEvent);
    return () => window.removeEventListener("services-tab", handleTabEvent);
  }, []);
  ...
  return (
    <section
      id="services"
      className="relative z-10 py-16 sm:py-32 overflow-hidden"
    ...
    >
      <div className="max-w-screen-xl mx-auto px-6 sm:px-10">
        ...
        <div className="relative z-5 my-2 sm:my-8 flex w-full flex-col items-center justify-center gap-2">
          <div className="flex h-[320px] sm:h-[520px] w-full max-w-5xl flex-col items-center justify-center overflow-hidden transition-all duration-500">
        ...
        <div
          className="mt-6 sm:mt-20 flex items-start justify-center self-stretch border-y"
...
function FeatureCard({
  ...
  return (
    ...
    >
      ...
      <div
        className="flex flex-col justify-center self-stretch text-sm font-bold tracking-tight md:text-lg"
        style={{ color: "var(--text-primary)" }}
      >
        {title}
      </div>
      <div
        className="self-stretch text-xs sm:text-sm font-light leading-relaxed"

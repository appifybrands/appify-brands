...
const demos = [
  {
    id: "demo1",
    title: "Shangarf Kashmir Resort & Homestay",
    subtitle: "Experience the pristine beauty of nature with seamless day and night mode transitions, interactive interior showcase, and luxury amenities.",
      ...
      <main className="relative z-10 min-h-screen pt-32 pb-24 px-6 sm:px-10 max-w-screen-xl mx-auto flex flex-col">
        ...
        <div className="mb-16 pt-10">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-semibold uppercase tracking-[0.2em] text-emerald-400 mb-6"
          >
            Luxury Hospitality
          </motion.div>
          ...
          >
            Explore our high-converting, immersive website designs for luxury homestays, boutique resorts, and vacation rentals.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {demos.map((demo, index) => (
            <motion.div
              ...
              className="group flex flex-col lg:col-span-2"
            >
              <Link
                href={demo.href}
                className="relative block w-full overflow-hidden rounded-2xl border border-white/10 bg-black/20 backdrop-blur-md mb-6"
              >
                <div className="relative w-full h-[50vh] min-h-[350px]">
                  ...
                  <div className="absolute top-6 left-6">
                    <span className="px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider bg-emerald-500/80 backdrop-blur-md text-white border border-emerald-400/30">
                      {demo.tag}
                    </span>
                  </div>
                </div>
              ...
              <div className="flex flex-col px-2">
                <Link href={demo.href} className="inline-block w-fit">
                  <h3
                ...
                <div className="mt-6">
                  <Link
                    href={demo.href}
                    className="inline-flex items-center px-8 py-4 rounded-full text-sm font-bold tracking-widest uppercase transition-all duration-300 hover:scale-105 hover:shadow-xl bg-emerald-600 hover:bg-emerald-500 text-white shadow-md"
                  >
                    Explore Demo 1

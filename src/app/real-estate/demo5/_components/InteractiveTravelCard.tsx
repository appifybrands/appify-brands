    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Full-card click target — sits above image, below interactive controls */}
          <Link
            href={href}
          ...
          <div className="relative z-20 flex flex-col justify-between rounded-xl p-4 text-white">
            ...
            <motion.button
              ...
              style={{ transform: "translateZ(40px)" }}
              className={cn(
                "relative z-20 w-full rounded-lg py-3 text-center font-semibold text-white transition-colors",

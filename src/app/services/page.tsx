...
const services = [
  {
    ...
    description:
      "Showcase your work and personal brand with a clean, modern portfolio site built to impress clients and employers.",
  ...
  },
  {
    ...
    description:
      "Modern, responsive, and SEO-friendly agency websites tailored to your brand — built to attract clients and build trust.",
  ...
  },
  {
    ...
    description:
      "Revamp your existing website with a modern, responsive, and user-friendly design — priced per section.",
  ...
  },
  {
    ...
    description:
      "Build engaging learning management systems for online education and training programs with intuitive UX.",
  ...
  },
  {
    ...
    description:
      "Attractive websites for food and beverage businesses — from menus to reservation systems and online ordering.",
  ...
  },
  {
    ...
    description:
      "Robust online stores with secure payment integration, inventory management, and conversion-optimized layouts.",
...
const process = [
  {
    num: "01",
    step: "Discovery",
    desc: "We understand your goals & requirements in depth.",
  },
  {
    num: "02",
    step: "Design",
    desc: "We craft clean, user-friendly layouts in Figma.",
  },
  {
    num: "03",
    step: "Development",
    desc: "We build fast, responsive, production-ready websites.",
  },
  {
    num: "04",
    step: "Launch",
    desc: "We deploy, test, and support your live site.",
  },
];
    ...
    >
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, var(--bg-card) 0%, transparent 70%)",
            opacity: 0.6,
          }}
        />
      </div>
      ...
      <section className="relative z-10 pt-16 pb-24 max-w-screen-xl mx-auto px-6 sm:px-10">
        ...
        <span className="section-number block mb-8">
          — Services / Expertise
        </span>
        ...
        >
          <p
            ...
            style={{ color: "var(--text-secondary)" }}
          >
            Affordable, high-quality websites to help you grow online. Choose
            the perfect package for your needs.
            <span
              className="block mt-2 text-xs"
              style={{ color: "var(--text-secondary)", opacity: 0.6 }}
            >
              ✓ Free live hosting included &nbsp;·&nbsp; Domain not included
                ...
                >
                  <div className="flex items-start justify-between gap-6">
                    <div className="flex items-start gap-6">
                      <span
                        className="text-xs font-mono pt-1 w-6 shrink-0"
                    ...
                    <div className="flex items-center gap-3 pt-1 shrink-0">
                      <div className="hidden sm:flex gap-2">
                        {s.tags.map((tag) => (
                          <span
                            key={tag}
                            className="tag-chip opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                          >
                            {tag}
                          </span>
                        ))}
                ...
                {activeService !== null ? (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(to top, var(--bg-primary) 0%, transparent 55%)",
                        opacity: 0.8,
                      }}
                    />
          ...
          {services.map((s, i) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <h3
                  className="font-bold text-lg mt-1 tracking-tight"
                  style={{ color: "var(--text-primary)" }}
                >
                  {s.title}
                </h3>
      ...
      <section className="relative z-10 pb-32 max-w-screen-xl mx-auto px-6 sm:px-10">
        ...
        >
          <div>
            ...
            <h2
              className="font-black uppercase text-3xl sm:text-5xl tracking-tight"
